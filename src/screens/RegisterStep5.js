...
const RegisterStep5 = ({ navigation, formData, updateFormData, onNext, onBack }) => {
  const validateStep5 = () => {
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text style={styles.subtitle}>Step 5: What's your diet like?</Text>
            </Animatable.View>
            ...
            <View style={styles.form}>
              {renderPicker('Dietary Preference', 'dietaryPreference', [
                ...
                { 
                  label: 'Keto (Low carb, high fat)', 
                  value: 'keto' 
                },
                { 
                  label: 'Paleo (Whole foods, no processed)', 
                  value: 'paleo' 
                },
                { 
                  label: 'Mediterranean (Plant-based, healthy fats)', 
                  value: 'mediterranean' 
                }
              ])}
            </View>
